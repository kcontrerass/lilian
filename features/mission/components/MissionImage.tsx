...
export default function MissionImage() {
  return (
    <div className="relative w-full aspect-[4/3] lg:aspect-[1.05] max-w-[650px] mx-auto lg:mx-0">
      <div className="relative w-full h-full rounded-2xl lg:rounded-[20px] overflow-hidden shadow-xl lg:shadow-2xl">
        <Image
      ...
      <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 w-28 sm:w-36 lg:w-[180px] h-11 lg:h-[60px]">
        <Image
          src={MISSION_IMAGES.whiteLogo}
          alt="Lilian Logo"
          fill
          className="object-contain object-left"
          sizes="(max-width: 640px) 112px, (max-width: 1024px) 144px, 180px"
        />
      </div>
